 ...
 */
class Hero extends \App\Entity\Hero implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'button_message' => [parent::class, 'button_message', null],
        ...
        'button_message' => [parent::class, 'button_message', null],
