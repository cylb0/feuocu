 ...
 */
class ProductOptionValue extends \App\Entity\ProductOptionValue implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'hexacode' => [parent::class, 'hexacode', null],
        ...
        'hexacode' => [parent::class, 'hexacode', null],
