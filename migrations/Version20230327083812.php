 ...
 */
final class Version20230327083812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD image_id INT NOT NULL, DROP path');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD path VARCHAR(255) NOT NULL, DROP image_id');
    }
}
