 ...
 */
final class Version20230429132344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discount CHANGE value value DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discount CHANGE value value DOUBLE PRECISION DEFAULT NULL');
