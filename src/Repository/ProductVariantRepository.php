...
class ProductVariantRepository extends ServiceEntityRepository
{
    ...
    public function setQuantity(ProductVariant $entity, int $quantity, bool $flush = false): void
    {
    ...
    public function setPrice(ProductVariant $entity, ?float $price, bool $flush = false): void
    {
